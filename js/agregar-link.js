var btnAgregar = document.querySelector(".btn-agregarlink");


/*----------------------------------------------------------------------------------------------------------*/ 
function crearElemento() {
    var li = document.createElement("li");
    var inputValue = document.getElementById("inp-link").value;
    ...
    if (inputValue === '') {
        ...
        document.getElementById("lista-link").appendChild(li);
    }
...
var list = document.querySelector('.lista-link');
